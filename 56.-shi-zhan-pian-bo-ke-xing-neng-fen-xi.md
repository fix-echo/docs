...
我们刷新一下 Next.js 的页面，上报一些数据，再查看 [http://localhost:4001/metrics](http://localhost:4001/metrics)，可以看到产生了一批 Web Vitals 相关的数据指标：
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134106768.png)
