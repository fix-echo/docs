# 9.渲染篇\_React\_Server\_Component\_与\_SSR
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134323985.png)

这三点分别是**好的用户体验**、**易于维护**和**高性能**。但是这三点却很难兼顾，我们以 [Spotify](https://open.spotify.com/artist/3WrFJ7ztbogyGnTHbHJFl2) 这个网站的页面为例：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134324071.png)

这是一个音乐家介绍页面，内容主要包含两块区域，一块是热门单曲区域（TopTracks），一块是唱片目录（Discography），如果我们要模拟实现这样一个页面，使用 React，我们可能会这样写：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134325742.png)

看起来很简洁的样子，但当我们加上数据请求后，代码就会变成这个样子：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134325503.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134326485.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134327325.png)

React Server Component 把数据请求的部分放在服务端，由服务端直接给客户端返回带数据的组件。

最终的目标是：在原始只有 Client Components 的情况下，一个 React 树的结构如下：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134328447.png)

在使用 React Server Component 后，React 树会变成：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134329293.png)

其中黄色节点表示 React Server Component。在服务端，React 会将其渲染会一个包含基础 HTML 标签和**客户端组件占位**的树。它的结构类似于：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134329744.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134330966.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134331913.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134331608.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134332354.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134333858.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134334779.gif)
