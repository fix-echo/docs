...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133606543.png)

点击左边的 `New` 按钮，可以增加一个 Note，增加后，左侧笔记列表也会同时更新：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133606798.gif)

在编辑的时候，也可以删除一个 Note，删除后左侧笔记列表也会同时更新：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133607068.gif)

可以对现有的 Note 进行修改：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133608303.gif)

还可以在左侧用搜索框查找一个 Note：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133610793.gif)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133611563.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133612490.png)

运行 `npm run dev`，打开 `localhost: 3000`开启项目：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133613880.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133613044.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133614850.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133615376.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133616310.png)

我们已经成功的获取了 Redis 数据库中的数据，然后服务端渲染到了页面上。

现在在 Medis 中应该已经可以查看到写入的数据：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133616099.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133617661.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133618239.png)

你会发现 node\_modules 并没有 day.js，但如果你现在在 SidebarNoteList 组件的顶部添加 `'use client'`，声明为客户端组件，你会发现立刻就多了 day.js：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133618762.png)

#### 3. 最佳实践：多用服务端组件

这就是使用 React Server Compoent 的好处之一，服务端组件的代码不会打包到客户端的 bundle 中：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133619636.png)

### 总结

那么今天的内容就结束了，本篇我们大致知道了要做的项目内容，并新建了 Next.js 项目，学会了用 Redis 做个简易的数据库，最后通过引入时间处理库，了解了使用 React Server Component 的一个优势。

本篇的代码我已经上传到[代码仓库](https://github.com/mqyqingfeng/next-react-notes-demo/tree/main)的 Day1 分支：[https://github.com/mqyqingfeng/next-react-notes-demo/tree/day1](https://github.com/mqyqingfeng/next-react-notes-demo/tree/day1)，直接使用的时候不要忘记在本地开启 Redis。

### 参考链接

1. [https://github.com/reactjs/server-components-demo](https://github.com/reactjs/server-components-demo)
2. [https://www.youtube.com/watch?v=TQQPAU21ZUw\&t=15s\&ab\_channel=MetaOpenSource](https://www.youtube.com/watch?v=TQQPAU21ZUw\&t=15s\&ab_channel=MetaOpenSource)
3. [https://redis.io/docs/install/install-redis/install-redis-on-mac-os/](https://redis.io/docs/install/install-redis/install-redis-on-mac-os/)
