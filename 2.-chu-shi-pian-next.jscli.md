...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133411894.png)

完成选择之后，`create-next-app` 会自动创建项目文件并安装依赖，创建安装完的项目目录和文件如下：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133412775.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133412562.png)

命令行会提示运行在 `3000` 端口，我们在浏览器打开页面 [http://localhost:3000/](http://localhost:3000/)，看到如下内容即表示项目成功运行：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133413549.png)
...
你可以访问 [https://github.com/vercel/next.js/tree/canary/examples](https://github.com/vercel/next.js/tree/canary/examples) 查看有哪些示例代码。如果你想直接使用某个示例代码，就比如 `with-redux`，无须手动 clone 代码，在创建项目的时候使用 `--example` 参数即可直接创建：
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133414108.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133414706.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133415047.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133416348.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133417411.png)

通常执行 `npm run build` 和 `npm run start`后，你再打开控制台，会发现在生产环境中不支持性能测量：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133418295.png)

但如果你执行 `npx next build --profile` 再执行 `npm run start`，尽管 React 插件会显示当前在生产环境，但 Profiler 是可以使用的：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133418522.png)

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133419244.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133419343.png)
