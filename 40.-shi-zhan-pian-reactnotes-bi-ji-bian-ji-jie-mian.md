...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133639448.png)

当点击具体笔记的 `Edit` 按钮的时候进入该笔记的编辑页面：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133639715.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133640014.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133640874.png)

预览的时候，我们虽然用了 `<NotePreview>` 这个组件，但是代码没有打包到客户端中。但是当我们打开 `http://localhost:3000/note/edit/1702459188837`：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133641874.png)

你会发现，下载了客户端组件 `<NoteEditor>` 和 `<NotePreview>`，对应也使用了很多库。`page.js` 也变大了很多（424 kB）：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133642054.png)

最后再说说使用客户端组件时的一个注意事项，那就是不要使用 `async/await`，可能会出现报错：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133642926.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133643680.gif)

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133644294.gif)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133645305.gif)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133646322.png)

请求地址是当前页面，请求方法为 POST。请求内容正是我们传入的内容：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133647380.png)

响应内容为：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133647135.png)

如果我们不注释掉 `actions.js` 中的 `redirect`，然后我们编辑一条笔记，然后点击 `Done`，可以看到页面发送了一条 POST 请求：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133648849.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133648597.gif)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133649231.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133650483.png)

此时就没有刚才的错误信息了。现在让我们在开发者工具中禁用 JavaScript，你会发现表单依然能用：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133651991.gif)

当然在这个例子中，因为禁用了 JavaScript，所以左侧的笔记列表加载不出来，更改内容的时候右边也不会实时渲染，但至少表单提交成功了。

#### 4. useFormState 与 useFormStatus

React 的 [useFormState](https://react.dev/reference/react-dom/hooks/useFormState) 和 useFormStatus 非常适合搭配 Server Actions 使用。`useFormState` 用于根据 form action 的结果更新表单状态，`useFormStatus` 用于在提交表单时显示待处理状态。
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133652100.gif)\
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403133653055.gif)
...
1. 搭配使用 [useFormState](https://react.dev/reference/react-dom/hooks/useFormState) 和 useFormStatus
2. 特殊数据使用隐藏 input 提交
