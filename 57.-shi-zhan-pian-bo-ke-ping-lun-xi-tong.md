...
GitHub 地址（2k Star）：[https://github.com/walinejs/waline](https://github.com/walinejs/waline)\
演示地址：[https://waline.js.org/](https://waline.js.org/)

#### 2. Twikoo

[Twikoo](https://twikoo.js.org/)，一款简洁、安全、免费的网站评论系统。也分为云函数部署和前端部署，都提供了[教程](https://twikoo.js.org/quick-start.html)。

GitHub 地址（1.3k Star）：[https://github.com/twikoojs/twikoo](https://github.com/twikoojs/twikoo)\
演示地址：[https://twikoo.js.org/](https://twikoo.js.org/)
...
GitHub 地址（0.6k Star）：[https://github.com/SukkaW/DisqusJS](https://github.com/SukkaW/DisqusJS)\
演示地址：[https://disqusjs.skk.moe/](https://disqusjs.skk.moe/)
...
GitHub 地址（0.5k Star）：[https://github.com/devrsi0n/chirpy](https://github.com/devrsi0n/chirpy)\
演示地址：[https://chirpy.dev/play](https://chirpy.dev/play)
...
GitHub 地址（2.6k Star）：[https://github.com/djyde/cusdis](https://github.com/djyde/cusdis)\
演示地址：[https://cusdis.com/doc#/](https://cusdis.com/doc#/)

#### 7. utterances

[utterances](https://utteranc.es/)，基于 Github Issues 的轻量评论组件。

GitHub 地址（8.7k Star）：[https://github.com/utterance/utterances](https://github.com/utterance/utterances)\
演示地址：[https://utteranc.es/](https://utteranc.es/)
...
演示地址：[https://isso-comments.de/](https://isso-comments.de/)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134111159.png)

3. 创建应用后，进入应用，点击左下角的设置 - 应用凭证，获取 `AppID`、`AppKey`、`MasterKey` 等信息：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134112249.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134113831.png)

部署成功后，进入应用的设置页面，设置环境变量：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134113337.png)

配置三个环境变量 `LEAN_ID`, `LEAN_KEY` 和 `LEAN_MASTER_KEY` 。它们的值分别对应上一步在 `LeanCloud` 中获得的 `AppID`, `AppKey`, `MasterKey`。

然后重新部署（这步是为了让环境变量生效）：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134114400.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134115593.png)

配置成功后，访问 [https://waline.yayujs.com/](https://waline.yayujs.com/) 就可以查看评论前台界面：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134115314.png)

访问 [https://waline.yayujs.com/ui](https://waline.yayujs.com/ui) 就会进入评论管理后台：

![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134116409.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134116255.png)
...
![](https://pub-edb6c1c737224e43ac2a64832550b116.r2.dev/20250403134117857.png)
